...
public class WaveTimeView extends View {
    ...
    public WaveTimeView(Context context) {
        super(context);
    }

    public WaveTimeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public WaveTimeView(Context context, AttributeSet attrs, int defStyleAttr) {
