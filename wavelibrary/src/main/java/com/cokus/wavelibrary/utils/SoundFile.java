...
public class SoundFile {
    ...
    public interface ProgressListener {
         ...
         * loading the file or recording the audio, and false to cancel or stopPlay recording.
         */
    ...
    public static SoundFile record(ProgressListener progressListener) {
        if (progressListener == null) {
            // must have a progessListener to stopPlay the recording.
            return null;
        }
        SoundFile soundFile = new SoundFile();
        soundFile.setProgressListener(progressListener);
                ...
                if (firstSampleData
                    ...
                    if (mProgressListener != null) {
                        if (!mProgressListener.reportProgress((float) (tot_size_read) / mFileSize)) {
                            // We are asked to stopPlay reading the file. Returning immediately. The
    ...
    private void RecordAudio() {
        if (mProgressListener == null) {
            // A progress listener is mandatory
            // here, as it will let us know when to stopPlay recording.
            return;
        }
        mInputFile = null;
        mFileType = "wav";
        ...
        while (true) {
            ...
            // The returned value tells us if we should keep recording or stopPlay.
